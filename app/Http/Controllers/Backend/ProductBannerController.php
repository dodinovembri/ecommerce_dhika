...
class ProductBannerController extends Controller
{
    ...
    */
    ...
    public $file_storage    = "public/img/product_banner";
    ...
    */
    public $base    = "admin";
    public $index   = "admin/product_banner/index";
    public $create  = "admin/product_banner/create";
    public $store   = "admin/product_banner/store";
    public $show    = "admin/product_banner/show";
    public $edit    = "admin/product_banner/edit";
    public $update  = "admin/product_banner/update";
    public $destroy = "admin/product_banner/destroy";
    ...
    public function index()
    {
        ...
        $data['table_data'] = ProductBannerModel::all();
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "create_product_banner" => array(
                "text" => "Create Product Banner", 
                "link" => "#", 
                "is_active" => "active"
            )
        );
        $data['title'] = "Create Product Banner";
    ...
    public function edit($id)
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "edit_product_banner" => array(
                "text" => "Edit Product Banner", 
                "link" => "", 
                "is_active" => "active"
            )            
        );
        $data['title'] = "Edit Product Banner";
        ...
        $data['field_first'] = $this->field_first;
        $data['field_break'] = $this->field_break;
        $data['table_content'] = ProductBannerModel::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $update = ProductBannerModel::find($id);
        for ($i=0; $i < $count; $i++) { 
            $text_type = $arr_field_type[$i];
            $text_check = substr($text_type, 0, 3);
            if ($text_check == "cha") {
    ...
    public function destroy($id)
    {
        ...
        $findtodelete = ProductBannerModel::find($id);
        $findtodelete->delete();
