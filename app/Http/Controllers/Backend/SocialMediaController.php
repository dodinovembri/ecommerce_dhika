...
class SocialMediaController extends Controller
{
    ...
    */
    public $base    = "admin";
    public $index   = "admin/social_media/index";
    public $create  = "admin/social_media/create";
    public $store   = "admin/social_media/store";
    public $show    = "admin/social_media/show";
    public $edit    = "admin/social_media/edit";
    public $update  = "admin/social_media/update";
    public $destroy = "admin/social_media/destroy";
