...
class AboutUsController extends Controller
{
    ...
    */
    ...
    public $file_storage    = "public/img/about_us";
    ...
    */
    public $base    = "admin";
    public $index   = "admin/about_us/index";
    public $create  = "admin/about_us/create";
    public $store   = "admin/about_us/store";
    public $show    = "admin/about_us/show";
    public $edit    = "admin/about_us/edit";
    public $update  = "admin/about_us/update";
    public $destroy = "admin/about_us/destroy";
    ...
    public function index()
    {
        ...
        $data['table_data'] = AboutUsModel::all();
    ...
    public function create()
    {
        ...
        $data['breadcrumb'] = array(
            ...
            "create_about_us" => array(
                "text" => "Create About Us", 
                "link" => "#", 
                "is_active" => "active"
            )
        );
    ...
    public function edit($id)
    {
        ...
        $data['field_first'] = $this->field_first;
        $data['field_break'] = $this->field_break;
        $data['table_content'] = AboutUsModel::find($id);
    ...
    public function destroy($id)
    {
        ...
        $findtodelete = AboutUsModel::find($id);
        $findtodelete->delete();
