            ...
            <div class="card-body p-0 auth-header-box">
              <div class="text-center p-3">
                <a href="index.html" class="logo logo-admin">
                  <img src="{{ asset('img/logo-sm-dark.png') }}" height="50" alt="logo" class="auth-logo">
                </a>
                <h4 class="mt-3 mb-1 font-weight-semibold text-white font-18">Ecommerce Administrator</h4>   
                <p class="text-muted  mb-0">Sign in to continue to Backend Ecommerce.</p>  
              </div>
            </div>
